...
public sealed class FluidSimulation : IDisposable
{
    ...
    {
        Graphics.Blit(Texture2D.blackTexture, _v1);
        Graphics.Blit(Texture2D.blackTexture, _v2);
        Graphics.Blit(Texture2D.blackTexture, _v3);
        Graphics.Blit(Texture2D.blackTexture, _p1);
        Graphics.Blit(Texture2D.blackTexture, _p2);
        Graphics.Blit(Texture2D.blackTexture, _divW);
    }
