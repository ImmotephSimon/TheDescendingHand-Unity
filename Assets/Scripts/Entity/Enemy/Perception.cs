...
public class Perception : MonoBehaviour, IPerception
{
    ...
    private HashSet<Transform> invalidTargets = new();
    ...
    private void FindTarget()
    {
        ...
        for (int i = 0; i < hitCount; i++)
        {
            ...
            if (hit == null || invalidTargets.Contains(hit.transform)) continue;
    ...
    internal void SetTargetValidity(Transform target, bool isValid)
    {
        if (isValid) invalidTargets.Remove(target);
        else
        {
